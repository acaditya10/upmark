...
export const TestimonialsCarousel = ({ testimonials }: TestimonialsCarouselProps) => {
  ...
  return (
    <section className="container mx-auto px-6 relative z-10 my-32">
      ...
      <div className="max-w-5xl mx-auto relative">
        <div className="absolute -top-10 -left-10 text-white/5 z-0">
          <Quote size={120} />
        </div>
        
        <div className="relative z-10 bg-secondary-surface/40 border border-white/10 backdrop-blur-md p-10 md:p-16 rounded-3xl overflow-hidden min-h-[300px] flex items-center">
        ...
        {/* Controls */}
        <div className="flex justify-between items-center mt-8 px-4 flex-col sm:flex-row gap-6">
          <div className="flex gap-2">
            <button onClick={prevTestimonial} className="w-12 h-12 rounded-full border border-white/10 flex items-center justify-center hover:bg-white/5 hover:border-accent-blue/50 transition-all text-white">
               <ChevronLeft size={20} />
            </button>
            <button onClick={nextTestimonial} className="w-12 h-12 rounded-full border border-white/10 flex items-center justify-center hover:bg-white/5 hover:border-accent-blue/50 transition-all text-white">
               <ChevronRight size={20} />
            </button>
          </div>
          <Link href="/work#testimonials" className="text-white font-semibold flex items-center gap-2 hover:text-accent-blue transition-colors group">
