...
export const Hero = ({ videoUrl }: HeroProps) => {
  ...
  return (
    <section className="relative min-h-screen flex items-center pt-0 pb-16 overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10 flex flex-col items-start justify-center h-full text-left mt-20">
        
        {/* Soft radial darkening behind text to maintain readability against bright video */}
        <div className="absolute top-[40%] left-[-10%] -translate-y-1/2 w-[1000px] h-[800px] bg-primary-bg/80 blur-[120px] rounded-full pointer-events-none -z-10"></div>
        ...
        >
          <div className="inline-flex items-center gap-2 px-3 py-1.5 mb-6 rounded-full border border-accent-blue/30 bg-accent-blue/10 backdrop-blur-md shadow-[0_0_20px_rgba(59,130,246,0.15)] text-accent-blue text-[10px] sm:text-xs tracking-widest uppercase font-semibold">
            <span className="w-1.5 h-1.5 rounded-full bg-accent-blue animate-pulse"></span>
            Integrated Marketing Agency
          </div>
          
          <h1 className="text-5xl md:text-7xl font-extrabold leading-[1.1] mb-6 tracking-tight font-heading">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-start gap-4">
            <Link href="/contact" className="group relative w-full sm:w-auto flex items-center justify-center gap-3 bg-accent-blue text-white px-8 py-4 rounded-lg font-semibold text-base overflow-hidden transition-all hover:scale-[1.02] active:scale-95 shadow-[0_0_30px_-10px_rgba(59,130,246,0.6)]">
        ...
        <motion.div 
          ...
          className="mt-20 grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-16 relative w-full max-w-4xl"
        >
          {/* Subtle Top Border */}
